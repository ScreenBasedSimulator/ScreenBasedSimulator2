...
public class TestSuite
{
  ...
  public void run(){Log.warn("Base TestSuite does not execute");}
  ...
  public void setTime(double time, String unit)
  {
	  this.testSuite.getTime().setValue(time);
	  this.testSuite.getTime().setUnit(unit);
  }
  ...
  public static SEFunction binEqualErrors(double limit, List<Double> error)
  {
    ...
    errBin.setAbscissa(tmp1);
    errBin.setOrdinate(tmp2);
    return errBin;
  }
}
