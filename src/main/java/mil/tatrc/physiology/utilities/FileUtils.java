...
public class FileUtils
{
  public static void main(String[] args)
  {
  	try
  	{
  		String fileName = "HAPI_2011_6_19--21_5_2_211--5620";
  		String[] files=FileUtils.getFilesOfSameName(fileName,".zip");
  		FileUtils.zipFiles(files, "(U)"+fileName);
  	}
  	catch(Exception e)
  	{
  		e.printStackTrace();
  	...
  	if (FileUtils.compareBinaryFiles("./cldgen/dust/hpa04-dst.out", "./cldgen/dust/hpa04-dst.out"))
  	{
  	  Log.info("./cldgen/dust/hpa04-dst.out is equal to itself");
  	}
  	else
  	{
      Log.error("./cldgen/dust/hpa04-dst.out is NOT equal to itself");
  	}
  	
  	if (FileUtils.compareBinaryFiles("./cldgen/dust/hpa04-dst.out", "./cldgen/dust/hpa05-dst.out"))
  	{
  	  Log.error("./cldgen/dust/hpa04-dst.out is equal to ./cldgen/dust/hpa05-dst.out");
  	}
  	else
  	{
  	  Log.info("./cldgen/dust/hpa04-dst.out is NOT equal to ./cldgen/dust/hpa05-dst.out");
  	}
  	
  	if (FileUtils.compareBinaryFiles("./nucsim/lodef.bin", "./nucsim/lodefCopy.bin"))
  	{
  	  Log.info("./nucsim/lodef.bin is equal to ./nucsim/lodefCopy.bin");
  	}
  	else
  	{
      Log.error("./nucsim/lodef.bin is NOT equal to ./nucsim/lodefCopy.bin");
  	}
  }
   ...
   * @throws IOException
   */
  public static File createFile(String directory, String filename, String extension, String classification) throws IOException
  {
   ...
   */
  public static File createFile(String directory, String filename, String ext, String classification, String content)
  { 
    File file = null;
   ...
   * @return
   */
  public static void changeDirectoryName(String directory, String newName)
  {
  ...
  public static void zipFiles(String[] fileNames, String zipFileName)
  {
  	try
  	{
  		...
  		for(int i = 0; i < fileNames.length; i++)
  		{
  			if(fileNames[i].equals(zipFileName+".zip"))
