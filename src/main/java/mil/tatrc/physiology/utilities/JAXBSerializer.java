...
public class JAXBSerializer
{
   ...
   */
  public Object serialize(String xml)
  {
    try
    {
      ByteArrayInputStream stream = new ByteArrayInputStream(xml.getBytes());
      JAXBElement<?> data = (JAXBElement<?>)unmarshaller.unmarshal(stream); 
  ...
  public Object readFile(String fileName)
  {
    try
    {
      ...
      JAXBElement<?> data = (JAXBElement<?>)unmarshaller.unmarshal(fin); 
      fin.close();
      return data.getValue();
    }
    catch (Exception e)
    {
      Log.error("Error Reading XML File "+fileName,e);
      return null;
    }
  }
  ...
  public Object binaryDecode(String data)
  {
    try
    {
  ...
  public Object binaryDecode(byte[] bytes)
  {
    try
    {
      if(bytes==null)
  ...
  public Object binaryDecodeDecompress(byte[] bytes)
  {
    try
    {
      if(bytes==null)
  ...
  public String binaryEncodeToString(Object o)
  {
    try
    {
  ...
  public byte[] binaryEncodeToBytes(Object o)
  {
    try
    {
  ...
  public byte[] binaryEncodeCompressToBytes(Object o)
  {
    try
    {
      ByteArrayOutputStream baos = new ByteArrayOutputStream();
   ...
   */
  public boolean hasVaildFileExtension(String fileName)
  {
