...
public class SESubstanceClearance
{
	...
	protected SEScalarVolumePerTimePerMass intrinsicClearance;
	protected SEScalarVolumePerTimePerMass renalClearance;
	...
	protected SEScalarVolumePerTimePerMass systemicClearance;
  ...
  public boolean load(SubstanceClearanceData data)
	{
		...
		if(data.getSystemic()!=null)
		{
		  ...
		  {
		    fuip = sys.getRenalClearance().getValue();
	...
	public SEScalarVolumePerTimePerMass getIntrinsicClearance() 
	{ 
		if(this.intrinsicClearance==null)
			this.intrinsicClearance=new SEScalarVolumePerTimePerMass();
	...
	public SEScalarVolumePerTimePerMass getRenalClearance() 
	{ 
		if(this.renalClearance==null)
			this.renalClearance=new SEScalarVolumePerTimePerMass();
  ...
  public boolean hasGlomerularFilterability() {return this.glomerularFilterability==null?false:this.glomerularFilterability.isValid();}
	...
	public SEScalarVolumePerTimePerMass getSystemicClearance() 
	{ 
		if(this.systemicClearance==null)
			this.systemicClearance=new SEScalarVolumePerTimePerMass();
