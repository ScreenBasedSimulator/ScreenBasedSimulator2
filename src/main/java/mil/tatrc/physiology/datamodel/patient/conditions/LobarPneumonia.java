...
public class LobarPneumonia extends SEPatientCondition
{
	...
	protected SEScalarFraction leftLungAffected;
	protected SEScalarFraction rightLungAffected;
  ...
  public SEScalarFraction getLeftLungAffected()
  {
    if (leftLungAffected == null)
      leftLungAffected = new SEScalarFraction();
  ...
  public SEScalarFraction getRightLungAffected()
  {
    if (rightLungAffected == null)
      rightLungAffected = new SEScalarFraction();
