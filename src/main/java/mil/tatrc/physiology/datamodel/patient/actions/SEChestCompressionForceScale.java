...
{
	protected SEScalarFraction forceScale;
	...
	public SEScalarFraction getForceScale()
	{
		if (forceScale == null)
			forceScale = new SEScalarFraction();
		return forceScale;
	}
	...
	public String toString()
	{
		if (forceScale != null)
			return "Patient Intervention : Chest Compression" 
					+ "\n\tForceScale: " + getForceScale()
					+ "\n\tForcePeriod: " + getForcePeriod();
		else
