...
{
  protected SEScalarFraction bronchitisSeverity;
  protected SEScalarFraction emphysemaSeverity;
  ...
  public SEScalarFraction getBronchitisSeverity()
  {
    if (emphysemaSeverity == null)
      emphysemaSeverity = new SEScalarFraction();
  ...
  public SEScalarFraction getEmphysemaSeverity()
  {
    if (emphysemaSeverity == null)
      emphysemaSeverity = new SEScalarFraction();
    return emphysemaSeverity;
