...
{
	protected SEScalarFraction expiratoryReserveVolumeFraction;
	...
	public SEScalarFraction getExpiratoryReserveVolumeFraction()
	{
		if (expiratoryReserveVolumeFraction == null)
			expiratoryReserveVolumeFraction = new SEScalarFraction();
