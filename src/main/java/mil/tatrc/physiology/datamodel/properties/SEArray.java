...
public class SEArray extends SEProperty
{
  ...
  protected double[] eData;
  protected List<Double> eList;
  protected EnumErrorType errorType;
  ...
  public boolean set(SEArray ary)
  {
    ...
    if (ary.eData != null)
      this.eData = Arrays.copyOf(ary.eData, ary.eData.length);
    if (ary.eList != null && !ary.eList.isEmpty())
      this.eList.addAll(ary.eList);
    this.errorType = ary.errorType;
  ...
  public boolean load(ArrayData data)
  {
    ...
    {
      setError(data.getError().getValue(),data.getError().getType());
    }
    return this.setDoubleData(data.getValue(),data.getUnit());
  }
  ...
  protected void unload(ArrayData to)
  {
    ...
    if(this.dData!=null)
      toList(to.getValue(),this.dData,this.precision);
    else
      to.getValue().addAll(this.dList);
    if(hasError())
    {
      to.setError(CDMSerializer.objFactory.createErrorList());
      if(this.eData!=null)
        toList(to.getError().getValue(),this.eData,this.precision);
      else
        to.getError().getValue().addAll(this.eList);
      to.getError().setType(this.errorType);
    }
  }
  ...
  public void setError(double[] error, EnumErrorType type)
  {
    this.eData=error;
    this.eList=null;
    this.errorType=type;
  ...
  public void setError(List<Double> error, EnumErrorType type)
  {
    this.eData = null;
    this.eList = error;
    this.errorType = type;
  ...
  {
    if (this.eList!=null && !this.eList.isEmpty())
      return toArray(this.eList);
    return this.eData;
  }
