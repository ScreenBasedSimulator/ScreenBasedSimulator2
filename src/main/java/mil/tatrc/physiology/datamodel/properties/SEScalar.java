...
public class SEScalar
{
  ...
  public boolean setValue(double val, int precision)
  {
    this.precision=precision;
    return this.setValue(val);
  }

  public boolean setValue(double val, String unit)
  {
    if (validUnit(unit))
    {
      if(unit==null)
  ...
  public boolean setValue(double val, String unit, int precision)
  {
    this.precision=precision;
    return this.setValue(val,unit);
  }
