...
public class CommonUnits
{
   ...
   * Unit Abbreviation Standards: http://www.bipm.org/en/si/
   */
  public enum VolumePerTimePerAreaUnit 
  {
  	mL_Per_min_Per_m2("mL/min m^2"), mL_Per_s_Per_m2("mL/s m^2");
    private String unit;
    private VolumePerTimePerAreaUnit(String unit)
    {
      this.unit=unit;
    }
    public String toString(){return this.unit;}
    public static boolean contains(String unit)
    {
      for(VolumePerTimePerAreaUnit v : VolumePerTimePerAreaUnit.values())
      {
        if(v.toString().equals(unit))
          return true;
      }
    ...
    public static boolean validUnit(String unit)
    {
      if(unit == null || unit.isEmpty())
        return false;
      if(VolumePerTimePerAreaUnit.contains(unit))
        return true;
   ...
   * Unit Abbreviation Standards: http://www.bipm.org/en/si/
   */
  public enum VolumePerTimePerPressurePerAreaUnit 
  {
  	mL_Per_min_Per_mmHg_Per_m2("mL/min mmHg m^2"), mL_Per_s_Per_mmHg_Per_m2("mL/s mmHg m^2");
    private String unit;
    private VolumePerTimePerPressurePerAreaUnit(String unit)
    {
      this.unit=unit;
    }
    public String toString(){return this.unit;}
    public static boolean contains(String unit)
    {
      for(VolumePerTimePerPressurePerAreaUnit v : VolumePerTimePerPressurePerAreaUnit.values())
      {
        if(v.toString().equals(unit))
          return true;
      }
    ...
    public static boolean validUnit(String unit)
    {
      if(unit == null || unit.isEmpty())
        return false;
      if(VolumePerTimePerPressurePerAreaUnit.contains(unit))
        return true;
   ...
   * Unit Abbreviation Standards: http://www.bipm.org/en/si/
   */
  public enum VolumePerTimePerMassUnit 
  {
  	mL_Per_s_Per_g("mL/s g"),
  	mL_Per_min_Per_kg("mL/min kg");
    private String unit;
    private VolumePerTimePerMassUnit(String unit)
    {
      this.unit=unit;
    }
    public String toString(){return this.unit;}
    public static boolean contains(String unit)
    {
      for(VolumePerTimePerMassUnit v : VolumePerTimePerMassUnit.values())
      {
        if(v.toString().equals(unit))
          return true;
      }
    ...
    public static boolean validUnit(String unit)
    {
      if(unit == null || unit.isEmpty())
        return false;
      if(VolumePerTimePerMassUnit.contains(unit))
        return true;
  ...
  public enum VolumePerTimePerPressureUnit 
  {
    ...
    public static boolean contains(String unit)
    {
      for(VolumePerTimePerPressureUnit v : VolumePerTimePerPressureUnit.values())
      {
        if(v.toString().equals(unit))
          return true;
      }
    ...
    public static boolean validUnit(String unit)
    {
      if(unit == null || unit.isEmpty())
        return false;
      if(VolumePerTimePerPressureUnit.contains(unit))
        return true;
