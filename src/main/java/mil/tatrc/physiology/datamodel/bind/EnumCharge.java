...
/**
 * <p>Java class for enumCharge.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="enumCharge">
...
public enum EnumCharge {
    ...
    public static EnumCharge fromValue(String v) {
        for (EnumCharge c: EnumCharge.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
