...
public abstract class SEFluidCompartment<T> extends SECompartment<T>
{
  ...
  protected SEScalarVolumePerTime outFlow;
	...
	protected SEScalarVolume unstressedVolume;
	...
	public void reset()
	{
	  ...
	  if (outFlow != null)
		...
		if (volume != null)
			volume.invalidate();
		if (unstressedVolume != null)
			unstressedVolume.invalidate();
	}
	...
	public boolean load(FluidCompartmentData in)
	{
      ...
      getOutFlow().load(in.getOutFlow()); 
		...
		if (in.getUnstressedVolume() != null) 
		   getUnstressedVolume().load(in.getUnstressedVolume()); 
	...
	protected void unload(FluidCompartmentData data)
	{
      ...
      data.setOutFlow(outFlow.unload());
		...
		if (unstressedVolume != null)
			data.setUnstressedVolume(unstressedVolume.unload());	
	}
  ...
  public boolean hasPressure()
  {
	...
	public SEScalarVolume getUnstressedVolume() 
	{
		if (unstressedVolume == null)
			unstressedVolume = new SEScalarVolume();
		return unstressedVolume;
	}
	public boolean hasUnstressedVolume()
	{
		return unstressedVolume == null ? false : unstressedVolume.isValid();
	}
}
