...
public class SELiquidCompartment<T> extends SEFluidCompartment<T>
{
  protected SEScalar pH;
	protected List<SELiquidCompartmentSubstanceQuantity> substanceQuantities;
	
	public SELiquidCompartment()
	{
	  super();
		this.substanceQuantities=new ArrayList<SELiquidCompartmentSubstanceQuantity>();
	}
	...
	public void reset()
	{
		super.reset();
		this.pH=null;
		for (SELiquidCompartmentSubstanceQuantity sq : this.substanceQuantities)
			sq.reset();
	}
  ...
  public boolean hasPH()
  {
	...
	{
		for (SELiquidCompartmentSubstanceQuantity csq : substanceQuantities)
		{
	...
	public SELiquidCompartmentSubstanceQuantity getSubstanceQuantity(SESubstance substance)
	{
		for (SELiquidCompartmentSubstanceQuantity csq : substanceQuantities)
		{
		...
		SELiquidCompartmentSubstanceQuantity csq = new SELiquidCompartmentSubstanceQuantity(substance);
		substanceQuantities.add(csq);
		return csq;
	}
	public List<SELiquidCompartmentSubstanceQuantity> getSubstanceQuantities()
	{
