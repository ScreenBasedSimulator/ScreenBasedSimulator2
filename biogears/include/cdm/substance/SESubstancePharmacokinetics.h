...
public:
	...
	*/
	...
	bool Load(const CDM::SubstancePharmacokineticsData& in);
	std::unique_ptr<CDM::SubstancePharmacokineticsData> Unload() const;
protected:
	void Unload(CDM::SubstancePharmacokineticsData& data) const;
public:
