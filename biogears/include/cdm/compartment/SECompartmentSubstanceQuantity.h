...
#pragma once
class SESubstance;
CDM_BIND_DECL(CompartmentSubstanceQuantityData)

class DLL_DECL SECompartmentSubstanceQuantity
{
public:
	virtual ~SECompartmentSubstanceQuantity(){};
	...
	*/
	...
	virtual const SESubstance& GetSubstance() const = 0;
