...
public:
	...
	SEChestOcclusiveDressing(const SEChestOcclusiveDressing& other);
	virtual void Copy(const SEChestOcclusiveDressing& other);
	...
	bool Load(const CDM::ChestOcclusiveDressingData& in);
	std::unique_ptr<CDM::ChestOcclusiveDressingData> Unload() const;
protected:
	void Unload(CDM::ChestOcclusiveDressingData& data) const;
public:
