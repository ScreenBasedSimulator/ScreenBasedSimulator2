...
public:
	...
	SESubstanceCompoundInfusion(const SESubstanceCompoundInfusion& other);
	...
	bool Load(const CDM::SubstanceCompoundInfusionData& in);
	std::unique_ptr<CDM::SubstanceCompoundInfusionData> Unload() const;
protected:
	void Unload(CDM::SubstanceCompoundInfusionData& data) const;
public:
