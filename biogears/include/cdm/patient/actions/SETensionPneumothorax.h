...
public:
	...
	SETensionPneumothorax(const SETensionPneumothorax& other);
	virtual void Copy(const SETensionPneumothorax& other);
	...
	bool Load(const CDM::TensionPneumothoraxData& in);
	std::unique_ptr<CDM::TensionPneumothoraxData> Unload() const;
protected:
	void Unload(CDM::TensionPneumothoraxData& data) const;
public:
