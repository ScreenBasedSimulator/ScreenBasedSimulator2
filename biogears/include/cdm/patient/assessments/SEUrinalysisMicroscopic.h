...
#include "bind/enumMicroscopicObservationAmount.hxx"
#include "bind/enumMicroscopicObservationType.hxx"
CDM_BIND_DECL(UrinalysisMicroscopicData)
...
public:
	...
	bool Load(const CDM::UrinalysisMicroscopicData& in);
	std::unique_ptr<CDM::UrinalysisMicroscopicData> Unload();
protected:
	void Unload(CDM::UrinalysisMicroscopicData& data);
public:
