...
public:
	...
	bool Load(const CDM::ComprehensiveMetabolicPanelData& in);
	std::unique_ptr<CDM::ComprehensiveMetabolicPanelData> Unload();
protected:
	void Unload(CDM::ComprehensiveMetabolicPanelData& data);
public:
	bool HasAlbumin();
