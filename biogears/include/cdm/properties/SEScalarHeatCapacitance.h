...
class DLL_DECL SEScalarHeatCapacitance : public SEScalar
{
...
public:
	...
	static std::shared_ptr<CCompoundUnit> J_Per_K;
	static std::shared_ptr<CCompoundUnit> kJ_Per_K; 
	static std::shared_ptr<CCompoundUnit> kcal_Per_K;
	static std::shared_ptr<CCompoundUnit> kcal_Per_C;
};