...
class DLL_DECL SEScalarEnergy : public SEScalar
{
...
public:
	...
	static std::shared_ptr<CCompoundUnit> J; // Joules
	static std::shared_ptr<CCompoundUnit> mJ; // milliJoules
	static std::shared_ptr<CCompoundUnit> kJ; // kiloJoules
	static std::shared_ptr<CCompoundUnit> kcal; // kilocalories
};
