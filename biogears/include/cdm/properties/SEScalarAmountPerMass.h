...
class DLL_DECL SEScalarAmountPerMass : public SEScalar
{
...
public:
	...
	static std::shared_ptr<CCompoundUnit> ct_Per_g; //molecules per gram
	static std::shared_ptr<CCompoundUnit> ct_Per_ug; //molecules per gram
};
