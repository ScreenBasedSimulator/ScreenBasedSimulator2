...
class DLL_DECL SEScalarVolumePerTimePerArea : public SEScalar
{

public:
	SEScalarVolumePerTimePerArea();
	virtual ~SEScalarVolumePerTimePerArea() {}
	...
	static std::shared_ptr<CCompoundUnit> mL_Per_min_Per_m2;

	static std::shared_ptr<CCompoundUnit> mL_Per_s_Per_m2;
