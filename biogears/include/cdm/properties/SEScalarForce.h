...
class DLL_DECL SEScalarForce : public SEScalar
{
...
public:
	...
	static std::shared_ptr<CCompoundUnit> N;// Newton
	static std::shared_ptr<CCompoundUnit> lbf;// pound force
	static std::shared_ptr<CCompoundUnit> dyn;// dyne
};
