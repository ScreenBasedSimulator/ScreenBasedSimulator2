...
class DLL_DECL SEScalarArea : public SEScalar
{
...
public:
	...
	static std::shared_ptr<CCompoundUnit> cm2;// square centimeters
	static std::shared_ptr<CCompoundUnit> m2;// square meters
};