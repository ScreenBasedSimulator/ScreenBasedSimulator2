...
class DLL_DECL SEScalarHeatResistanceArea : public SEScalar
{
...
public:
	...
	static std::shared_ptr<CCompoundUnit> rsi;
	static std::shared_ptr<CCompoundUnit> clo;
	static std::shared_ptr<CCompoundUnit> rValue;
	static std::shared_ptr<CCompoundUnit> tog;
};