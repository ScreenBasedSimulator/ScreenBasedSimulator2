...
class DLL_DECL SEScalarFlowElastance : public SEScalar
{
...
public:
	...
	static std::shared_ptr<CCompoundUnit> cmH2O_Per_L;//cmH2O/L
	static std::shared_ptr<CCompoundUnit> mmHg_Per_mL;//mmHg/mL
	static std::shared_ptr<CCompoundUnit> Pa_Per_m3;
};
