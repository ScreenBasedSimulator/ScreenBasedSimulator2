...
class DLL_DECL SEScalarVolumePerPressure : public SEScalar
{
...
public:
	...
	static std::shared_ptr<CCompoundUnit> L_Per_Pa;// Liters per pascal
	static std::shared_ptr<CCompoundUnit> L_Per_cmH2O;// Liters per pascal
};
