...
class DLL_DECL SEScalarFlowCompliance : public SEScalar
{
...
public:
	...
	static std::shared_ptr<CCompoundUnit> L_Per_cmH2O;//L/cmH2O
	static std::shared_ptr<CCompoundUnit> mL_Per_mmHg;//mL/mmHg
	static std::shared_ptr<CCompoundUnit> mL_Per_cmH2O;//mL/mmHg
	static std::shared_ptr<CCompoundUnit> m3_Per_Pa;
};
