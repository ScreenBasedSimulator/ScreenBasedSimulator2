...
class DLL_DECL SEScalarPressurePerVolume : public SEScalar
{
...
public:
	...
	static std::shared_ptr<CCompoundUnit> mmHg_Per_mL;
	static std::shared_ptr<CCompoundUnit> cmH2O_Per_mL;
};
