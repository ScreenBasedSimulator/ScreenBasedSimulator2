...
class DLL_DECL SEScalarTemperature : public SEScalar
{
...
public:
	...
	static std::shared_ptr<CCompoundUnit> F;// degrees Fahrenheit
	static std::shared_ptr<CCompoundUnit> C;// degrees Celcius
	static std::shared_ptr<CCompoundUnit> K;// Kelvin
	static std::shared_ptr<CCompoundUnit> R;// rankine
};
