...
class DLL_DECL SEScalarHeatConductancePerArea : public SEScalar
{
...
public:
	...
	static std::shared_ptr<CCompoundUnit> W_Per_m2_K;
	static std::shared_ptr<CCompoundUnit> W_Per_m2_C;
	static std::shared_ptr<CCompoundUnit> BTU_Per_hr_ft2_C;
};