...
class DLL_DECL SEScalarHeatConductance : public SEScalar
{
...
public:
	...
	static std::shared_ptr<CCompoundUnit> W_Per_K; // Watt/Kelvin
	static std::shared_ptr<CCompoundUnit> W_Per_C; // Watt/Degrees C
	static std::shared_ptr<CCompoundUnit> kcal_Per_K_s; // kcal/K-s
	static std::shared_ptr<CCompoundUnit> kcal_Per_C_s; // kcal/DegC-s
};