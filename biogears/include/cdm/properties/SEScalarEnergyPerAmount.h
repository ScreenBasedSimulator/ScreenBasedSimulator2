...
class DLL_DECL SEScalarEnergyPerAmount : public SEScalar
{
...
public:
	...
	static std::shared_ptr<CCompoundUnit> kcal_Per_mol; //kilocalorie per mol
	static std::shared_ptr<CCompoundUnit> kJ_Per_mol; //kilojoule per mol
};
