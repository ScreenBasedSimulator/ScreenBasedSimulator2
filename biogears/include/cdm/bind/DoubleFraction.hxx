...
/**
 * @file
 * @brief Generated from DoubleFraction.xsd.
 */

#ifndef DOUBLE_FRACTION_HXX
#define DOUBLE_FRACTION_HXX
...
namespace mil
{
  namespace tatrc
  {
    namespace physiology
    {
      ...
      {
        /**
         * @brief Class corresponding to the %DoubleFraction schema type.
         *
         * @nosubgrouping
         */
        class DoubleFraction: public ::xsd::cxx::tree::fundamental_base< ::xml_schema::double_, char, ::xml_schema::simple_type, ::xsd::cxx::tree::schema_type::double_ >
        {
           ...
           */
          DoubleFraction (const ::xml_schema::double_&);
           ...
           * instance.
           */
          DoubleFraction (const ::xercesc::DOMElement& e,
           ...
           * instance.
           */
          DoubleFraction (const ::xercesc::DOMAttr& a,
                          ::xml_schema::flags f = 0,
                          ::xml_schema::container* c = 0);
           ...
           * instance.
           */
          DoubleFraction (const ::std::string& s,
           ...
           */
          DoubleFraction (const DoubleFraction& x,
                          ::xml_schema::flags f = 0,
                          ::xml_schema::container* c = 0);
