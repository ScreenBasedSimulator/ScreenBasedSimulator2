  ...
  namespace tatrc
  {
    namespace physiology
    {
      ...
      namespace datamodel
      {
         ...
         * @nosubgrouping
         */
        class __attribute__ ((visibility ("default"))) SubstanceBolusData: public ::mil::tatrc::physiology::datamodel::SubstanceAdministrationData
        {
          public:
          /**
           * @name Substance
           ...
           */
          typedef ::mil::tatrc::physiology::datamodel::enumSubstanceAdministration AdminRoute_type;
