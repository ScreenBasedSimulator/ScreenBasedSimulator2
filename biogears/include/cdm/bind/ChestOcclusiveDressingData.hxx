  ...
  namespace tatrc
  {
    namespace physiology
    {
      ...
      namespace datamodel
      {
         ...
         * @nosubgrouping
         */
        class __attribute__ ((visibility ("default"))) ChestOcclusiveDressingData: public ::mil::tatrc::physiology::datamodel::PatientActionData
        {
          public:
          /**
           * @name State
           ...
           */
          ChestOcclusiveDressingData (const Side_type&);
