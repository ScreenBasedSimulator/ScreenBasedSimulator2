...
/**
 * @file
 * @brief Generated from DataRequestListData.xsd.
 */

#ifndef DATA_REQUEST_LIST_DATA_HXX
#define DATA_REQUEST_LIST_DATA_HXX
...
namespace mil
{
  namespace tatrc
  {
    namespace physiology
    {
      ...
      {
        /**
         * @brief Class corresponding to the %DataRequestListData schema type.
         *
         * @nosubgrouping
         */
        class DataRequestListData: public ::xml_schema::type
        {
          public:
          /**
           * @name DataRequest
           ...
           * instance.
           */
          DataRequestListData (const ::xercesc::DOMElement& e,
           ...
           */
          DataRequestListData (const DataRequestListData& x,
                               ::xml_schema::flags f = 0,
                               ::xml_schema::container* c = 0);
           ...
           */
          DataRequestListData&
          operator= (const DataRequestListData& x);
...
namespace mil
{
  namespace tatrc
  {
    namespace physiology
    {
      ...
      {
        ::std::ostream&
        operator<< (::std::ostream&, const DataRequestListData&);
      }
    }
  }
}
...
namespace mil
{
  namespace tatrc
  {
    namespace physiology
    {
      ...
      {
        void
        operator<< (::xercesc::DOMElement&, const DataRequestListData&);
      }
    }
  }
}
...
#endif // DATA_REQUEST_LIST_DATA_HXX
