  ...
  namespace tatrc
  {
    namespace physiology
    {
      ...
      namespace datamodel
      {
         ...
         * @nosubgrouping
         */
        class __attribute__ ((visibility ("default"))) GasCompartmentData: public ::mil::tatrc::physiology::datamodel::FluidCompartmentData
        {
          public:
          /**
           ...
           * @brief Element type.
           */
          typedef ::mil::tatrc::physiology::datamodel::GasCompartmentSubstanceQuantityData SubstanceQuantity_type;
