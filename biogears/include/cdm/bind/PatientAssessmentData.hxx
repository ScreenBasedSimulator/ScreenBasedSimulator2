  ...
  namespace tatrc
  {
    namespace physiology
    {
      ...
      namespace datamodel
      {
         ...
         * @nosubgrouping
         */
        class __attribute__ ((visibility ("default"))) PatientAssessmentData: public ::xml_schema::type
        {
          public:
          /**
           * @name Constructors
           ...
           * instance.
           */
          PatientAssessmentData (const ::xercesc::DOMAttr& a,
                                 ::xml_schema::flags f = 0,
                                 ::xml_schema::container* c = 0);
           ...
           * instance.
           */
          PatientAssessmentData (const ::std::string& s,
  ...
  namespace tatrc
  {
    namespace physiology
    {
      namespace datamodel
      {
        ...
        __attribute__ ((visibility ("default")))
        void
        operator<< (::xercesc::DOMAttr&, const PatientAssessmentData&);
