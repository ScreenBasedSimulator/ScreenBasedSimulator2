  ...
  namespace tatrc
  {
    namespace physiology
    {
      ...
      namespace datamodel
      {
         ...
         * @nosubgrouping
         */
        class __attribute__ ((visibility ("default"))) ChronicAnemiaData: public ::mil::tatrc::physiology::datamodel::PatientConditionData
        {
          public:
          /**
           ...
           * @brief Element type.
           */
          typedef ::mil::tatrc::physiology::datamodel::ScalarFractionData ReductionFactor_type;
