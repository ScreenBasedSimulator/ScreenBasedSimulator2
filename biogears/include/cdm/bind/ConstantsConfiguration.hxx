...
/**
 * @file
 * @brief Generated from ConstantsConfiguration.xsd.
 */

#ifndef CONSTANTS_CONFIGURATION_HXX
#define CONSTANTS_CONFIGURATION_HXX
...
namespace mil
{
  namespace tatrc
  {
    namespace physiology
    {
      ...
      {
        /**
         * @brief Class corresponding to the %ConstantsConfiguration schema type.
         *
         * @nosubgrouping
         */
        class __attribute__ ((visibility ("default"))) ConstantsConfiguration: public ::xml_schema::type
        {
          public:
          /**
           ...
           * @brief Element type.
           */
          typedef ::mil::tatrc::physiology::datamodel::ScalarData StefanBoltzmann_type;
           ...
           * @brief Element type.
           */
          typedef ::mil::tatrc::physiology::datamodel::ScalarHeatCapacitancePerMassData UniversalGasConstant_type;
           ...
           * instance.
           */
          ConstantsConfiguration (const ::xercesc::DOMElement& e,
           ...
           */
          ConstantsConfiguration (const ConstantsConfiguration& x,
                                  ::xml_schema::flags f = 0,
                                  ::xml_schema::container* c = 0);
           ...
           */
          virtual ConstantsConfiguration*
           ...
           */
          ConstantsConfiguration&
          operator= (const ConstantsConfiguration& x);
  ...
  namespace tatrc
  {
    namespace physiology
    {
      namespace datamodel
      {
        ...
        ::std::ostream&
        operator<< (::std::ostream&, const ConstantsConfiguration&);
      }
    }
  }
}
  ...
  namespace tatrc
  {
    namespace physiology
    {
      namespace datamodel
      {
        __attribute__ ((visibility ("default")))
        void
        operator<< (::xercesc::DOMElement&, const ConstantsConfiguration&);
      }
    }
  }
}
...
#endif // CONSTANTS_CONFIGURATION_HXX
