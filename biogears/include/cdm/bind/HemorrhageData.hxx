  ...
  namespace tatrc
  {
    namespace physiology
    {
      ...
      namespace datamodel
      {
         ...
         * @nosubgrouping
         */
        class __attribute__ ((visibility ("default"))) HemorrhageData: public ::mil::tatrc::physiology::datamodel::PatientActionData
        {
          public:
          /**
           * @name Rate
           ...
           */
          HemorrhageData (const Rate_type&,
                          const Compartment_type&);
           ...
           */
          HemorrhageData (::std::unique_ptr< Rate_type >,
                          const Compartment_type&);
