  ...
  namespace tatrc
  {
    namespace physiology
    {
      ...
      namespace datamodel
      {
         ...
         * @nosubgrouping
         */
        class __attribute__ ((visibility ("default"))) ForcedInhaleData: public ::mil::tatrc::physiology::datamodel::ConsciousRespirationCommandData
        {
          public:
          /**
           ...
           * @brief Element type.
           */
          typedef ::mil::tatrc::physiology::datamodel::ScalarFractionData InspiratoryCapacityFraction_type;
