  ...
  namespace tatrc
  {
    namespace physiology
    {
      ...
      namespace datamodel
      {
         ...
         * schema type.
         */
        class __attribute__ ((visibility ("default"))) enumCompartmentType: public ::xml_schema::string
        {
          public:
          ...
          public:
          static const char* const _xsd_enumCompartmentType_literals_[6];
          static const value _xsd_enumCompartmentType_indexes_[6];
