...
/**
 * @file
 * @brief Generated from enumCompartment.xsd.
 */

#ifndef ENUM_COMPARTMENT_HXX
#define ENUM_COMPARTMENT_HXX
...
namespace mil
{
  namespace tatrc
  {
    namespace physiology
    {
      ...
      {
        /**
         * @brief Class corresponding to the %enumCompartment schema type.
         *
         * @nosubgrouping
         */
        class __attribute__ ((visibility ("default"))) enumCompartment: public ::xml_schema::string
        {
           ...
           */
          enumCompartment (const char*);

          /**
           * @brief Create an instance from a string andinitializers
           * for required elements and attributes.
           */
          enumCompartment (const ::std::string&);

          /**
           * @brief Create an instance from the ultimate base and
           * initializers for required elements and attributes.
           */
          enumCompartment (const ::xml_schema::string&);
           ...
           * instance.
           */
          enumCompartment (const ::xercesc::DOMElement& e,
           ...
           * instance.
           */
          enumCompartment (const ::xercesc::DOMAttr& a,
                           ::xml_schema::flags f = 0,
                           ::xml_schema::container* c = 0);
           ...
           * instance.
           */
          enumCompartment (const ::std::string& s,
           ...
           */
          enumCompartment (const enumCompartment& x,
                           ::xml_schema::flags f = 0,
                           ::xml_schema::container* c = 0);
