...
/**
 * @file
 * @brief Generated from MealData.xsd.
 */

#ifndef MEAL_DATA_HXX
#define MEAL_DATA_HXX
...
namespace mil
{
  namespace tatrc
  {
    namespace physiology
    {
      ...
      {
        /**
         * @brief Class corresponding to the %MealData schema type.
         *
         * @nosubgrouping
         */
        class __attribute__ ((visibility ("default"))) MealData: public ::mil::tatrc::physiology::datamodel::NutritionData
        {
          public:
          /**
           * @name ElapsedTime
           ...
           */
          MealData (const ElapsedTime_type&);
           ...
           */
          MealData (::std::unique_ptr< ElapsedTime_type >);
           ...
           * instance.
           */
          MealData (const ::xercesc::DOMElement& e,
  ...
  namespace tatrc
  {
    namespace physiology
    {
      namespace datamodel
      {
        ...
        ::std::ostream&
        operator<< (::std::ostream&, const MealData&);
      }
    }
  }
}
  ...
  namespace tatrc
  {
    namespace physiology
    {
      namespace datamodel
      {
        __attribute__ ((visibility ("default")))
        void
        operator<< (::xercesc::DOMElement&, const MealData&);
      }
    }
  }
}
