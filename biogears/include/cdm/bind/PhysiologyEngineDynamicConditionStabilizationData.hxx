  ...
  namespace tatrc
  {
    namespace physiology
    {
      ...
      namespace datamodel
      {
         ...
         * @nosubgrouping
         */
        class __attribute__ ((visibility ("default"))) PhysiologyEngineDynamicConditionStabilizationData: public ::mil::tatrc::physiology::datamodel::PhysiologyEngineConditionStabilizationData
        {
          public:
          /**
           * @name Criteria
