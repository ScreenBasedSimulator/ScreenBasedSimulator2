  ...
  namespace tatrc
  {
    namespace physiology
    {
      ...
      namespace datamodel
      {
         ...
         * @nosubgrouping
         */
        class __attribute__ ((visibility ("default"))) ForcedExhaleData: public ::mil::tatrc::physiology::datamodel::ConsciousRespirationCommandData
        {
          public:
          /**
           ...
           * @brief Element type.
           */
          typedef ::mil::tatrc::physiology::datamodel::ScalarFractionData ExpiratoryReserveVolumeFraction_type;
