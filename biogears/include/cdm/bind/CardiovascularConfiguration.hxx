...
/**
 * @file
 * @brief Generated from CardiovascularConfiguration.xsd.
 */

#ifndef CARDIOVASCULAR_CONFIGURATION_HXX
#define CARDIOVASCULAR_CONFIGURATION_HXX
...
namespace mil
{
  namespace tatrc
  {
    namespace physiology
    {
      ...
      {
        /**
         * @brief Class corresponding to the %CardiovascularConfiguration schema type.
         *
         * @nosubgrouping
         */
        class CardiovascularConfiguration: public ::xml_schema::type
        {
           ...
           * instance.
           */
          CardiovascularConfiguration (const ::xercesc::DOMElement& e,
           ...
           */
          CardiovascularConfiguration (const CardiovascularConfiguration& x,
                                       ::xml_schema::flags f = 0,
                                       ::xml_schema::container* c = 0);
           ...
           */
          virtual CardiovascularConfiguration*
           ...
           */
          CardiovascularConfiguration&
          operator= (const CardiovascularConfiguration& x);
...
#endif // CARDIOVASCULAR_CONFIGURATION_HXX
