...
public:
	...
	/**
	 * If findMin is true, Peaked will return true on a bottom peak
	 * If findMax is true, Peaked will return true on a top peak
	 *
	 * Default class behavior is findMin=false, findMax=true
	 */
	void Find(bool findMin, bool findMax);
