...
public:
	...
	// TODO SetLogger, but then everything that derives from this would need to recursivly set all it's childrens logger to this provided logger
...
public:
	...
	virtual void SetLogTime(SEScalarTime* time);
