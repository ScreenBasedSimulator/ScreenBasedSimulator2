...
public:
	...
	void Copy(const SEAnesthesiaMachineOxygenBottle& from);
	void Merge(const SEAnesthesiaMachineOxygenBottle& from);

	virtual void Reset(); //reset values
	virtual void Clear(); //clear memory

	bool Load(const CDM::AnesthesiaMachineOxygenBottleData& in);
	std::unique_ptr<CDM::AnesthesiaMachineOxygenBottleData> Unload() const;
protected:
	void Unload(CDM::AnesthesiaMachineOxygenBottleData& data) const;
